...
(function(){
  ...
  var T = {
    ...
    step1_p: { es:"La piedra sale de las minas del cinturón esmeraldífero de Boyacá: Muzo, Chivor, Coscuez o La Pita, cada una con un carácter de color distinto.", en:"The stone comes from the mines of the Boyacá emerald belt: Muzo, Chivor, Coscuez or La Pita, each with a distinct color character.", fr:"La pierre provient des mines de la ceinture émeraudifère de Boyacá : Muzo, Chivor, Coscuez ou La Pita, chacune avec un caractère de couleur distinct.", pt:"A pedra sai das minas do cinturão esmeraldífero de Boyacá: Muzo, Chivor, Coscuez ou La Pita, cada uma com um caráter de cor distinto." },
